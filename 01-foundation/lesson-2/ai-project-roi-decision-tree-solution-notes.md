...
graph LR
    ...
    classDef question fill:#f9f,stroke:#333,stroke-width:2px,color:#333,font-size:16px;
    classDef decision fill:#lightgrey,stroke:#333,stroke-width:2px,color:#333,font-size:16px;
    classDef outcomeGreen fill:#ccffcc,stroke:#333,stroke-width:2px,color:#333,font-size:16px;
    classDef outcomeRed fill:#ffcccc,stroke:#333,stroke-width:2px,color:#333,font-size:16px;
    classDef outcomeOrange fill:#ffebcc,stroke:#333,stroke-width:2px,color:#333,font-size:16px;
